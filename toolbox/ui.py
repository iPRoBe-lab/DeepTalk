...
class UI(QDialog):
    ...
    def play(self, wav, sample_rate):
        ...
        filepath = os.getcwd()+'/samples/'+filename+'.wav'
        self.log("Saving Audio to: "+filepath)
        librosa.output.write_wav(filepath, wav, sample_rate)
        sd.stop()
    ...
    def __init__(self):
        ...
        self.module_name = QPlainTextEdit("model_baseline")
        gen_layout.addWidget(self.module_name, stretch=1)
